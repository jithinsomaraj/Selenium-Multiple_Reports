package projectListCaseswithAllureReportandReadExcelMethode2;
...
public class ProjectListCases2 {
	WebDriver driver;
	LoginPage LoginPage;
	Common Common;
	...
	@Test(description="verify ProjectList Page",dataProvider = "ProjectList-Verify") // it should be the Test Name 
