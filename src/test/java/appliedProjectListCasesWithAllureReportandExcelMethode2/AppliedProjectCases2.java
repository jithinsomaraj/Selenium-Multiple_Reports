package appliedProjectListCasesWithAllureReportandExcelMethode2;
...
public class AppliedProjectCases2 {
	...
	@Test(description="verify AppliedProjectList Page",dataProvider="AppliedProjectList") // it should be the Test Name 
	...
	public void AppliedProjectListCases(String TCID, String TCDescription, String expTestApplying,String expTestDuringTrade,String expTestEOT,String expTestCancelled,String expTestFailed) throws InterruptedException {
		Common.Wait(AppliedProjectPage.AppliedprojectListBtnBy());
	...
	@DataProvider(name = "AppliedProjectList")
	public Object[][] Apllied_projectList() {
		Object[][] AppliedList = ReadExcel.ReadTestData(this.getClass().getSimpleName(), "AppliedProjectListCases", 7);
		return AppliedList;
	}
